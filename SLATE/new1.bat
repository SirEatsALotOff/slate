...
IF %versioninof%==%oldvnum% (
	...
	set xx=https://github.com/SirEatsALotOff/slate/releases/download/%versioninof%/slateInstaller.EXE
	start "" https://github.com/SirEatsALotOff/slate/releases/download/v.2/slateInstaller.EXE
 )
 :end
 echo Finished.
 pause
